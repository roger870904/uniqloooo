				...
				<nav id="nav">
					<ul>
                        ...
                        if($_SESSION['name']==null)
                        {
						    ...
						    echo '<li><a href="register.php" class="button special">Sign Up</a></li>';
                        }
						else{
                            echo '<li class="active"><a href="#">帳戶名稱:'.$_SESSION['name'].'</a></li>';
						    echo '<li><a href="#"><imput type="button"onclick='.unset($_SESSION['name']);header("refresh:0;url=index2.php");.'span class="glyphicon glyphicon-log-in"></span> 登出</a></li>';
                        }
						?>
