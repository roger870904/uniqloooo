    ...
    .loginBox label[for="remember"] {
        font: 11px Arial;
			...
			<body>
                ...
                echo '<form action="processforbuy.php" method="post">';
                echo '<input type="hidden" name="id" value='.$id.'>';
                echo '<label for="fname" align=center>收件人姓名: </label>';
                echo '<input type="text" id="Recipient" name="Recipient" required="required"><br>';
                echo '<label for="lname"align=center>收件地址: </label>';
                echo '<input type="text" id="address" name="address" required="required"><br>';
                echo '<label for="lname"align=center>商品數量: </label>';
                echo '<input type="text" id="amount" name="amount" required="required"><br>';
                echo '<div style="text-align:center"> ';
                echo '<button type = "submit" name = "buy" id = "buy_btn">確定預購</button>';
                ?>
